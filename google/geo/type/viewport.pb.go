...
type Viewport struct {
	...
	Low *LatLng `protobuf:"bytes,1,opt,name=low,proto3" json:"low,omitempty"`
	// Required. The high point of the viewport.
	High                 *LatLng  `protobuf:"bytes,2,opt,name=high,proto3" json:"high,omitempty"`
...
func (m *Viewport) GetHigh() *LatLng {
	if m != nil {
		return m.High
	}
	return nil
...
var fileDescriptor_52240f0f30767909 = []byte{
	...
	,
}
...
func NewPopulatedViewport(r randyViewport, easy bool) *Viewport {
	this := &Viewport{}
	if r.Intn(5) != 0 {
		this.Low = NewPopulatedLatLng(r, easy)
	}
	if r.Intn(5) != 0 {
		this.High = NewPopulatedLatLng(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
...
func (this *Viewport) String() string {
	...
	s := strings.Join([]string{`&Viewport{`,
		`Low:` + strings.Replace(fmt.Sprintf("%v", this.Low), "LatLng", "LatLng", 1) + `,`,
		`High:` + strings.Replace(fmt.Sprintf("%v", this.High), "LatLng", "LatLng", 1) + `,`,
